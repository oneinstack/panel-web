    ...
    >
        ...
        <el-form ref="formRef" :model="modelRef" :rules="rulesRef" label-width="80px">
            <el-form-item :label="$t('table.name')" prop="name">
                <el-input v-model="modelRef.name" placeholder="名称" disabled="true" style="width:100%" size="mini"/>
            </el-form-item>
...
export default ({
    ...
    setup(props) {
        ...
        const modelRef = reactive({
            ...
            value_rule: props.values.value_rule || '',
            value_type: props.values.value_type|| '',
