<template>
    ...
    >
        ...
        <el-form ref="formRef" :model="modelRef" :rules="rulesRef" label-width="90px">
            <el-form-item :label="$t('table.name')" prop="name">
                <el-input v-model="modelRef.name" placeholder="组名" style="width: 100%" size="mini"/>
            </el-form-item>
            <el-form-item :label="$t('table.dev_manager_by')" prop="dev_manager_by" size="mini" >
                 <el-select 
